...
export default function RegisterPage() {
  ...
  return (
    ...
    <div className="flex w-full h-full px-10 py-10 justify-between place-items-center mt-12">
      <div className="bg-white w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl justify-center align-middle ">
        ...
        <form className="flex flex-col w-auto items-center" onSubmit={registerUser}>
          ...
          <div className="input">
            ...
            <input type="text" placeholder="Hobbies" className="input-et" value={hobbies} onChange={ev => setHobbies(ev.target.value)} />
          </div>
